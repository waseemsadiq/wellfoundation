...
summary: Please select the education project(s) that you would like to donate towards. If you need more info please contact <a href="mailto:fahim.baqir@wellfoundation.org.uk" class="text-indigo-500 underline">Fahim Baqir</a>.
slug: education
visible: false
form:
    name: education-form

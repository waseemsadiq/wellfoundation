---
route: subscriptions/[digit:page]?
layout: products/snipcart-v2
summary: Well Foundation Monthly Subscriptions 
image: images://food-cover.jpg
visible: false
collection:
    model: airtable
    config:
        url: https://api.airtable.com/v0/appBkb3dw8veD8BO3/water?api_key=keyziFXaehsfT8Rzk
        identity_key: slug
    state:  
        filter:
    ...
    <div class="container flex flex-col items-center h-full max-w-7xl mx-auto">
        ...
        <div class="flex items-center max-w-7xl mx-auto">
            <?  foreach(collection() as $product): ?>
                <a class="mx-8" href="/subscriptions/<?= $product->slug ?>"><?= $product->title ?></a>
            <? endforeach; ?>
        </div>

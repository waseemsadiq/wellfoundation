    ...
    <div class="relative px-8 py-10  border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="bank-details" class="container flex flex-col items-center h-full max-w-7xl mx-auto">
            ...
            <div class="relative lg:px-20">
              <p class="pr-0 mb-8 text-center text-base   text-gray-600 md:text-lg xl:text-xl lg:pr-20">To make a general donation by bank transfer, simply contact your bank to arrange the funds to be transferred directly to our bank account.</p>
              <p class="pr-0 mb-8 text-center text-base   text-gray-600 md:text-lg xl:text-xl lg:pr-20">Specify <strong class="uppercase">general fund</strong> as the payment reference and we will do the rest.<br>THE WELL Foundation ’s bank details are shown below.</p>
            </div>
            <div class="flex flex-wrap py-6 lg:px-20">
                    ...
                    <dl>
                      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                          50 Cadzow Street<br>Hamilton<br>Lanarkshire<br>ML3 6DU<br>Scotland<br>UK<br>01698 282868
                        </dd>
                      </div>
                      ...
                      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                          Account for (&pound;) Sterling donations:
                        </dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                          00629281<br>IBAN GB66RBOS83222600629281<br>IBAN BIC or SWIFT- RBOSGB2
                        </dd>
                      </div>
                    </dl>
                  </div>
              ...
              <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <a class="md:cursor-default mb-2" href="sms:70085&body=WFMB">
                  <div class="bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 mb-2 shadow-md" role="alert">
                      <div class="flex">
                        <div class="py-1">
                        ...
                        <div>
                          ...
                          <p class="leading-relaxed">You can also make a donation by SMS (short message service) by texting <strong>WFMB</strong> to 70085 You will be billed £5 (five pounds sterling) by your mobile phone operator.</p>
                        </div>
                    </div>
                  </div>
                </a>

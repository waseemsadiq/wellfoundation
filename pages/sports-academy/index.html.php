...
---
    ...
    <div class="relative px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 lg:pb-40 lg:px-20 xl:py-40 xl:px-20">
      ...
      <div class="relative pb-20 lg:pb-40 lg:px-20">
          <p class="px-8 mb-6 text-base text-gray-600 sm:text-lg xl:text-xl lg:px-20">The Well Foundation works with a number of organisations including Scottish Football Association, Motherwell FC, The Rangers FC and The Princes' Trust, ensuring opportunities for sport and participation are made available to everyone regardless of their background or abilities.</p>

...
---
    ...
    <div class="relative lg:pb-40 lg:px-20">
      <p class="px-8 mb-2 text-2xl md:text-xl lg:text-base   text-gray-600 md:text-lg xl:text-xl lg:px-20">How will we benefit at The Well Foundation? What we would require from your business as our responsible partners is that we have our charity logo printed on your business’s stationary depending on the nature of you business this may be advertisement posters, menus, information flyers, letters etc. We will provide you with our charity logo to be added to your media. We hope this will increase the chances of people making the effort to find out who The Well Foundation is and more importantly become more aware of the plight of those who the charity is looking to aid.</p>
      <p class="px-8 mb-2 text-2xl md:text-xl lg:text-base   text-gray-600 md:text-lg xl:text-xl lg:px-20">We hope to grow The Well Foundation over the coming years and help as many people as we can, we hope you will join us in this mission as our partners and gain the exposure which you will deserve for promoting The Well Foundation and its work and message.</p>
      <p class="px-8 mb-2 text-2xl md:text-xl lg:text-base   text-gray-600 md:text-lg xl:text-xl lg:px-20">We would like to give our members and contributors over the last couple of years the first opportunity to take up the proposal and create further bonds with the charity. If you wish to be involved in what we hope is an exciting opportunity and project please contact us as soon as you are able. You can get in touch with us in a number of ways through the website, or by leaving a message below.</p>
      <p class="px-8 mb-8 text-2xl md:text-xl lg:text-base   text-gray-600 md:text-lg xl:text-xl lg:px-20">We hope you consider this as a unique opportunity to be involved with a charity fast gaining reputation for its hard work, effort, determination and honesty and success in raising funds for the suffering across the world.</p>
    ...
    <div class="relative px-8 py-10  border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
      <div id="form" class="container flex flex-col items-center h-full max-w-7xl mx-auto">
          ...
          <p class="px-8 mb-2 text-2xl md:text-xl lg:text-base   text-gray-600 md:text-lg xl:text-xl lg:px-20">We work with our donors and provide feedback which includes project report and pictures of the wells and construction. All wells are personalised with a Plaque of the donors name or name chosen by the donor.</p>

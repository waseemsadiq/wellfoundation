...
img: images://education-cover.jpg
slug: education
modalCount: 1
---
...
<div class="relative px-8 py-10  border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
  ...
  <div id="education-projects" class="container flex flex-col items-center h-full max-w-7xl mx-auto">
    ...
    <h3 class="w-full max-w-4xl px-5 px-8 mt-2 text-2xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl md:px-0 mb-8">Projects delivered</h3>

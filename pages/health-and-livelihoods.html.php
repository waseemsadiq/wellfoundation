...
---
    ...
    <div class="relative px-8 py-10  border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div
            ...
            <div class="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
                ...
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Give a Man a fish he will eat for a day, Teach him to fish he will eat for a lifetime</p>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Over 1 billion people live on less than £1.25 a day. Nearly 250 million children have to work to help their families. More than 1.3 billion around the world live in extreme poverty</p>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">The Income Generating Programme helps poor families to set up income generating activities based on their skills and availability of local resources. In case of lack of skills and resources the programme also helps family members by providing training to enhance their skills. Through trained social mobilisers local resources are explored to create livelihood opportunities and generate income on a sustainable basis.</p>
    ...
    <div class="relative pb-20 lg:pb-40 lg:px-20">
        ...
        <p class="px-8 mb-6 text-base text-gray-600 sm:text-lg xl:text-xl lg:px-20">Many people in developing countries have the skills and enthusiasm to generate an income for themselves, yet lack the opportunity to put it into practice, we at the Well Foundation believe in empowering people to help themselves. We strive to give people access to sustainable ways of supporting themselves and their communities. With support from our donors we’re making a real difference.</p>

  ...
  <div class="bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md mb-6" role="alert">
    <div class="flex">
      ...
      <div>
        ...
        <p class="text-sm leading-relaxed">Please Save <a href="https://api.whatsapp.com/send?phone=447714247787" class="text-indigo-500 underline">07714 247787</a> under Well Foundation in your contacts so you can get <i>WhatsApp Broadcast</i> messages for all completed Projects.</p>
      </div>
    </div>
  </div>

  ...
  <div class="w-full text-gray-700">
    <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-2 mx-auto lg:items-center lg:justify-between lg:flex-row">
      <div class="p-4 flex flex-row items-center justify-between">
        <a href="/" title="Click here to go to the homepage">
          <?= import('/partials/logos/wellfoundation'); ?>
        </a>
        <!-- Button Mobile Nav -->
        <button class="lg:hidden focus:outline-none focus:shadow-outline p-2" @click="open = !open" title="Mobile menu button">

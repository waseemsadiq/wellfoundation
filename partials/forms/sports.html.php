<form method="post" action="<?= route('forms/sports') ?>" class="w-full">
  ...
  <div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-2/3">
      <input class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="DoctorsName" name="DoctorsName" type="text">
    </div>
  </div>

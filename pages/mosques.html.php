    ...
    <div class="relative px-8 py-10  border-t border-gray-200 xl:px-0">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <p class="mb-8 text-base text-gray-600 sm:text-lg xl:text-xl">Mosques are around the following size:</p>
                ...
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Please follow this link to:</p>
